...
(function webpackUniversalModuleDefinition(root, factory) {
	 ...
	 * });
            ...
            function dialog() {
                ...
                var $dialog = $dialogWrap.find('.lo-dialog');
                var $mask = $dialogWrap.find('.lo-mask');

                function hide() {
                    var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _util2.default.noop;

                    $mask.addClass('lo-animate-fade-out');
                    $dialog.addClass('lo-animate-fade-out').on('animationend webkitAnimationEnd', function () {
                        $dialogWrap.remove();
                        _sington = false;
                        callback();
                    });
                ...
                // 不能直接把.lo-animate-fade-in加到$dialog，会导致mask的z-index有问题
                $mask.addClass('lo-animate-fade-in');
                $dialog.addClass('lo-animate-fade-in');

                $dialogWrap.on('click', '.lo-dialog__btn', function (evt) {
                    var _this = this;
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            (0, _objectAssign2.default)(_balajs2.default, {
                 ...
                 * 例子：
                 *  <div>
                 *    <div class="lo-mask"></div>
                 *    <div class="lo-dialog">
                 *    <% if(typeof title === 'string'){ %>
	     *           <div class="lo-dialog__hd"><strong class="lo-dialog__title"><%=title%></strong></div>
	     *    <% } %>
                 *    <div class="lo-dialog__bd"><%=content%></div>
                 *    <div class="lo-dialog__ft">
                 *    <% for(var i = 0; i < buttons.length; i++){ %>
	     *        <a href="javascript:;" class="lo-dialog__btn lo-dialog__btn_<%=buttons[i]['type']%>"><%=buttons[i]['label']%></a>
	     *    <% } %>
                 *    </div>
                 *    </div>
                 *  </div>
        ...
        /***/ function(module, exports) {
            ...
            module.exports = "<div class=\"<%=className%>\"> <div class=lo-mask></div> <div class=\"lo-dialog <% if(isAndroid){ %> lo-skin_android <% } %>\"> <% if(title){ %> <div class=lo-dialog__hd><strong class=lo-dialog__title><%=title%></strong></div> <% } %> <div class=lo-dialog__bd><%=content%></div> <div class=lo-dialog__ft> <% for(var i = 0; i < buttons.length; i++){ %> <a href=javascript:; class=\"lo-dialog__btn lo-dialog__btn_<%=buttons[i]['type']%>\"><%=buttons[i]['label']%></a> <% } %> </div> </div> </div> ";
        ...
        /***/ function(module, exports, __webpack_require__) {
             ...
             * @example
             * lo.alert('普通的alert');
             * lo.alert('带回调的alert', function(){ console.log('ok') });
             * lo.alert('自定义标题的alert', { title: '自定义标题' });
             * lo.alert('带回调的自定义标题的alert', function(){
	 *    console.log('ok')
	 * }, {
	 *    title: '自定义标题'
	 * });
             * lo.alert('自定义按钮的alert', {
	 *     title: '自定义按钮的alert',
	 *     buttons: [{
	 *         label: 'OK',
	 *         type: 'primary',
	 ...
	 * });
        ...
        /***/ function(module, exports, __webpack_require__) {
             ...
             *
             * @example
             * lo.confirm('普通的confirm');
             * lo.confirm('自定义标题的confirm', { title: '自定义标题' });
             * lo.confirm('带回调的confirm', function(){ console.log('yes') }, function(){ console.log('no') });
             * lo.confirm('带回调的自定义标题的confirm', function(){ console.log('yes') }, function(){ console.log('no') }, {
	 *     title: '自定义标题'
	 * });
             * lo.confirm('自定义按钮的confirm', {
	 *     title: '自定义按钮的confirm',
	 *     buttons: [{
	 *         label: 'NO',
	 *         type: 'default',
	 ...
	 * });
            ...
            function toast() {
                ...
                $toast.addClass('lo-animate-fade-in');

                setTimeout(function () {
                    $toast.addClass('lo-animate-fade-out').on('animationend webkitAnimationEnd', function () {
                        $toast.remove();
                        _sington = false;
                        options.callback();
                    });
        ...
        /***/ function(module, exports) {
            ...
            module.exports = "<div class=\"<%= className %>\"> <div class=lo-mask_transparent></div> <div class=lo-toast> <i class=\"lo-icon_toast lo-icon-success-no-circle\"></i> <p class=lo-toast__content><%=content%></p> </div> </div> ";
        ...
        /***/ function(module, exports, __webpack_require__) {
             ...
             *
             * @example
             * var loading = lo.loading('loading', {
	 *     className: 'custom-classname'
	 * });
             * setTimeout(function () {
	 *     loading.hide();
	 * }, 3000);
            ...
            function loading() {
                ...
                function hide() {
                    $loading.addClass('lo-animate-fade-out').on('animationend webkitAnimationEnd', function () {
                        $loading.remove();
                        _sington = false;
                    });
                }
                (0, _util2.default)('body').append($loading);
                $loading.addClass('lo-animate-fade-in');
        ...
        /***/ function(module, exports) {
            ...
            module.exports = "<div class=\"lo-loading_toast <%= className %>\"> <div class=lo-mask_transparent></div> <div class=lo-toast> <i class=\"lo-loading lo-icon_toast\"></i> <p class=lo-toast__content><%=content%></p> </div> </div> ";
	 ...
	 * });
            ...
            function actionSheet() {
                ...
                var $actionSheet = $actionSheetWrap.find('.lo-actionsheet');
                var $actionSheetMask = $actionSheetWrap.find('.lo-mask');

                function hide() {
                    $actionSheet.addClass(isAndroid ? 'lo-animate-fade-out' : 'lo-animate-slide-down');
                    $actionSheetMask.addClass('lo-animate-fade-out').on('animationend webkitAnimationEnd', function () {
                ...
                $actionSheet.addClass(isAndroid ? 'lo-animate-fade-in' : 'lo-animate-slide-up');
                $actionSheetMask.addClass('lo-animate-fade-in').on('click', hide);
                $actionSheetWrap.find('.lo-actionsheet__menu').on('click', '.lo-actionsheet__cell', function (evt) {
                    var index = (0, _util2.default)(this).index();
                    menus[index].onClick.call(this, evt);
                    hide();
                });
                $actionSheetWrap.find('.lo-actionsheet__action').on('click', '.lo-actionsheet__cell', function (evt) {
                    var index = (0, _util2.default)(this).index();
        ...
        /***/ function(module, exports) {
            ...
            module.exports = "<div class=\"<% if(isAndroid){ %>lo-skin_android <% } %><%= className %>\"> <div class=lo-mask></div> <div class=lo-actionsheet> <div class=lo-actionsheet__menu> <% for(var i = 0; i < menus.length; i++){ %> <div class=lo-actionsheet__cell><%= menus[i].label %></div> <% } %> </div> <div class=lo-actionsheet__action> <% for(var j = 0; j < actions.length; j++){ %> <div class=lo-actionsheet__cell><%= actions[j].label %></div> <% } %> </div> </div> </div> ";
        ...
        /***/ function(module, exports, __webpack_require__) {
             ...
             * @example
             * lo.topTips('请填写正确的字段');
             * lo.topTips('请填写正确的字段', 3000);
             * lo.topTips('请填写正确的字段', function(){ console.log('close') });
             * lo.topTips('请填写正确的字段', {
	 *     duration: 3000,
	 *     className: 'custom-classname',
	 *     callback: function(){ console.log('close') }
	 * });
        ...
        /***/ function(module, exports) {
            ...
            module.exports = "<div class=\"lo-toptips lo-toptips_warn <%= className %>\" style=display:block><%= content %></div> ";
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            function searchBar(selector) {
                ...
                $eles.forEach(function (ele) {
                    ...
                    var $searchLabel = $searchBar.find('.lo-search-bar__label');
                    var $searchInput = $searchBar.find('.lo-search-bar__input');
                    var $searchClear = $searchBar.find('.lo-icon-clear');
                    var $searchCancel = $searchBar.find('.lo-search-bar__cancel-btn');

                    function cancelSearch() {
                        $searchInput.val('');
                        $searchBar.removeClass('lo-search-bar_focusing');
                    }

                    $searchLabel.on('click', function () {
                        $searchBar.addClass('lo-search-bar_focusing');
                        $searchInput[0].focus();
                    });
	 ...
	 * });
            ...
            function tab(selector) {
                ...
                $eles.forEach(function (ele) {
                    ...
                    var $tabItems = $tab.find('.lo-navbar__item, .lo-tabbar__item');
                    var $tabContents = $tab.find('.lo-tab__content');

                    $tabItems.eq(options.defaultIndex).addClass('lo-bar__item_on');
                    ...
                    $tabItems.on('click', function () {
                        ...
                        $tabItems.removeClass('lo-bar__item_on');
                        $this.addClass('lo-bar__item_on');
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            function _findCellParent(ele) {
                ...
                if (ele.classList.contains('lo-cell')) return ele;
            ...
            function _showErrorMsg(error) {
                if (error) {
                    ...
                    if (cellParent) cellParent.classList.add('lo-cell_warn');
                }
            }
             ...
             *
             * ``` js
             * // lo.form.validate('#form', function(error){ console.log(error);}); // error: {dom:[Object], msg:[String]}
             * lo.form.validate('#form', function (error) {
	 *     if (!error) {
	 *         var loading = lo.loading('提交中...');
	 *         setTimeout(function () {
	 *             loading.hide();
	 *             lo.toast('提交成功', 3000);
	 *         }, 1500);
            ...
            function checkIfBlur(selector) {
                ...
                $eles.forEach(function (ele) {
                    ...
                    $form.find('[required]').on('blur', function () {
                        ...
                        if (cellParent) cellParent.classList.remove('lo-cell_warn');
                    });
                });
	 ...
	 *            lo.alert('请上传不超过10M的图片');
	 *            return false;
	 *        }
	 *        if (files.length > 5) { // 防止一下子选择过多文件
	 *            lo.alert('最多只能上传5张图片，请重新选择');
	 *            return false;
	 *        }
	 *        if (uploadCount + 1 > 5) {
	 *            lo.alert('最多只能上传5张图片');
	 ...
	 * });
            ...
            function uploader(selector, options) {
                ...
                function findFileCtn($uploader, id) {
                    ...
                    var $fileCtn = $file.find('.lo-uploader__file-content');

                    if (!$fileCtn.length) {
                        $fileCtn = (0, _util2.default)('<div class="lo-uploader__file-content"></div>');
                        $file.append($fileCtn);
                    }
                    $file.addClass('lo-uploader__file_status');
                    return $fileCtn;
                }

                // 清除DOM里的上传状态
                function clearFileStatus($uploader, id) {
                    var $file = $uploader.find('[data-id="' + id + '"]').removeClass('lo-uploader__file_status');
                    $file.find('.lo-uploader__file-content').remove();
                }
                ...
                if (options.onBeforeQueued) {
                    (function () {
                        ...
                        options.onBeforeQueued = function (file, files) {
                            ...
                            $uploader.find('.lo-uploader__files').append($item);
                        };
                    })();
                }
                if (options.onQueued) {
                    ...
                    (function () {
                        ...
                        options.onError = function (file, err) {
                            if (!onError.call(file, err)) {
                                findFileCtn($uploader, file.id).html('<i class="lo-icon-warn"></i>');
                            }
                        };
                    })();
                }
        ...
        /***/ function(module, exports) {
            ...
            module.exports = "<li class=\"lo-uploader__file lo-uploader__file_status\" data-id=\"<%= id %>\"> <div class=lo-uploader__file-content> <i class=lo-loading style=width:30px;height:30px></i> </div> </li> ";
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var show = function show($picker) {
                ...
                $picker.find('.lo-mask').addClass('lo-animate-fade-in');
                $picker.find('.lo-picker').addClass('lo-animate-slide-up');
            };

            var hide = function hide($picker) {
                $picker.find('.lo-mask').addClass('lo-animate-fade-out');
                $picker.find('.lo-picker').addClass('lo-animate-slide-down').on('animationend webkitAnimationEnd', function () {
                    destroy($picker);
                });
            };
	 ...
	 * });
            ...
            function picker() {
                ...
                $picker.find('.lo-picker__bd').html(groups);
                show($picker);
                ...
                function scroll(items, level) {
                    ...
                    $picker.find('.lo-picker__group').eq(level).scroll({
                        items: items,
                        temp: lineTemp[level],
                        onChange: function onChange(item, index) {
                            ...
                            if (isMulti) {
                                ...
                                if (item.children && item.children.length > 0) {
                                    $picker.find('.lo-picker__group').eq(level + 1).show();
                                    !isMulti && scroll(item.children, level + 1); // 不是多列的情况下才继续处理children
                                } else {
                                    //如果子列表test不通过，子孙列表都隐藏。
                                    var $items = $picker.find('.lo-picker__group');
                ...
                $picker.on('click', '.lo-mask', function () {
                    hide($picker);
                }).on('click', '.lo-picker__action', function () {
                    hide($picker);
                }).on('click', '#lo-picker-confirm', function () {
	 ...
	 * });
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            _util2.default.fn.scroll = function (options) {
                ...
                var defaults = _util2.default.extend({
                    items: [], // 数据
                    scrollable: '.lo-picker__content', // 滚动的元素
                ...
                var items = defaults.items.map(function (item) {
                    return '<div class="lo-picker__item' + (item.disabled ? ' lo-picker__item_disabled' : '') + '">' + item.label + '</div>';
                }).join('');
                (0, _util2.default)(this).find('.lo-picker__content').html(items);
        ...
        /***/ function(module, exports) {
            ...
            module.exports = "<div class=\"<%= className %>\"> <div class=lo-mask></div> <div class=lo-picker> <div class=lo-picker__hd> <a href=javascript:; data-action=cancel class=lo-picker__action>取消</a> <a href=javascript:; data-action=select class=lo-picker__action id=lo-picker-confirm>确定</a> </div> <div class=lo-picker__bd></div> </div> </div> ";

            /***/ },
        /* 28 */
        /***/ function(module, exports) {

            module.exports = "<div class=lo-picker__group> <div class=lo-picker__mask></div> <div class=lo-picker__indicator></div> <div class=lo-picker__content></div> </div>";
	 ...
	 * });
            ...
            function gallery(url) {
                ...
                function hide() {
                    $gallery.addClass('lo-animate-fade-out').on('animationend webkitAnimationEnd', function () {
                        $gallery.remove();
                        _sington = false;
                    });
                }
                ...
                $gallery.find('.lo-gallery__img').on('click', hide);
                $gallery.find('.lo-gallery__del').on('click', function () {
                    options.onDelete.call(this, url);
                });

                $gallery.show().addClass('lo-animate-fade-in');
        ...
        /***/ function(module, exports) {
            ...
            module.exports = "<div class=\"lo-gallery <%= className %>\"> <span class=lo-gallery__img style=\"background-image:url(<%= url %>)\"><%= url %></span> <div class=lo-gallery__opr> <a href=javascript: class=lo-gallery__del> <i class=\"lo-icon-delete lo-icon_gallery-delete\"></i> </a> </div> </div> ";
	 ...
	 * });
            ...
            function slider(selector) {
                ...
                $eles.forEach(function (ele) {
                    ...
                    var $sliderInner = $slider.find('.lo-slider__inner');
                    var $sliderTrack = $slider.find('.lo-slider__track');
                    var $sliderHandler = $slider.find('.lo-slider__handler');
